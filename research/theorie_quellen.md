...
* **Geometrische Intuition:** [Computerphile: Lattice Based Cryptography](https://www.youtube.com/watch?v=K026C5YaB3A) (Erklärt das Problem der "schlechten Basis")
* **SVP & CVP:** [Wikipedia: Lattice-based cryptography](https://en.wikipedia.org/wiki/Lattice-based_cryptography#SVP_and_CVP) (Gute Visualisierung der Kernprobleme)
* **Lattice Cryptography:** [A Course in Lattice-based Cryptography](https://web.eecs.umich.edu/~cpeikert/pubs/lattice-survey.pdf) – Chris Peikert (Kapitel 2 für die geometrische Definition)
